        ...
        <div class="card mt-5 shadow-sm border-0">
            <div class="card-body p-4">
                <div class="text-center mb-4">
                    ...
                    <h3 class="card-title mt-2">Crear Cuenta de administrador</h3>
                </div>
                <form action="/streammatch/public/admin/register" method="POST">
                    <div class="mb-3">
                ...
                <div class="text-center mt-3">
                    <p class="text-muted small">¿Ya tienes cuenta? <a href="/streammatch/public/admin/login" class="text-decoration-none">Inicia sesión</a></p>
                </div>
            </div>
        </div>
    </div>
